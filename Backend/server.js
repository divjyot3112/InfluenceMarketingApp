    ...
    Task.updateMany(
        ...
        function (err, result) {
            if (err) {
                ...
                console.log("Number of tasks marked In Progress by Cron Job: " + result.nModified)
            }
        });
    ...
    Task.updateMany(
        ...
        function (err, result) {
            if (err) {
                ...
                console.log("Number of tasks marked Completed by Cron Job: " + result.nModified)
            }
        });
    ...
    Task.updateMany(
        ...
        function (err, result) {
            if (err) {
                ...
                console.log("Number of tasks marked Cancelled by Cron Job: " + result.nModified)
            }
        });
